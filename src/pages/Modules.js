...
const Modules = () => {
    ...
    const filteredModules = moduleList
        .filter((module) => {
            ...
            const matchesName =
                translationsModule.moduleName[module.id].toLowerCase().includes(lowerCaseSearchTerm) +
                translationsModule.moduleStat[module.moduleStat[0].value].toLowerCase().includes(lowerCaseSearchTerm) +
                module.id.includes(lowerCaseSearchTerm);
